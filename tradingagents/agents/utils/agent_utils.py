...
class Toolkit:
    ...
    def get_crypto_data_online(
        ...
        Args:
            ...
            end_date (str): End date in yyyy-mm-dd format
        Returns:
            str: A formatted dataframe containing crypto price data for the specified symbol in the specified date range.
        """

        result_data = interface.get_crypto_data_online(symbol, start_date, end_date)
    ...
    def get_crypto_info_online(
        ...
        Args:
            symbol (str): Crypto symbol like BTC, ETH, BTC-USD
        Returns:
            str: Formatted crypto market information including price, market cap, volume, and 24h change.
        """

        result_data = interface.get_crypto_info_online(symbol)
    ...
    def get_onchain_network_health(
        ...
        Returns:
            str: Formatted network health analysis including active addresses, hash rate, and health score
        """
        
        result_data = interface.get_onchain_network_health(symbol)
        return result_data
    ...
    def get_onchain_market_indicators(
        ...
        Args:
            symbol (str): Crypto symbol like BTC, ETH
        Returns:
            str: Formatted market indicators including exchange flows, whale activity, and market signals
        """
        
        result_data = interface.get_onchain_market_indicators(symbol)
        return result_data
    ...
    def get_onchain_comprehensive_analysis(
        ...
        """
        Retrieve comprehensive on-chain analysis combining network health, market indicators, and AI insights.
        Args:
            symbol (str): Crypto symbol like BTC, ETH
        Returns:
            str: Comprehensive on-chain analysis with investment thesis and confidence scoring
        """
        
        result_data = interface.get_onchain_comprehensive_analysis(symbol)
        return result_data
    ...
    def get_metric_registry_data(
        ...
        Args:
            metric (str): Specific metric name (active_addresses, whale_activity, exchange_flows, etc.)
            symbol (str): Crypto symbol like BTC, ETH
        Returns:
            str: Formatted metric data with fallback provider information
        """
        
        result_data = interface.get_metric_registry_data(metric, symbol)
        return result_data
    ...
    def get_exchange_ohlcv_data(
        ...
        result_data = interface.get_exchange_ohlcv_data(exchange, symbol, timeframe, limit)
        return result_data
    ...
    def get_exchange_order_book(
        ...
        result_data = interface.get_exchange_order_book(exchange, symbol, limit)
        return result_data
    ...
    def compare_crypto_exchanges(
        ...
        result_data = interface.compare_crypto_exchanges(symbol, exchanges)
        return result_data
